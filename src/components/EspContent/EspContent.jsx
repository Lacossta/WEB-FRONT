                ...
                <section className={"lang-page__info"}>
                    <div className={"lang-page__info-text-wrapper"}>
                        <p className={"lang-page__info-text"}>
                            Онлайн-занятия испанским языком — это возможность обучаться в любом комфортном для вас месте
                            и из любой точки мира.
                            <br/><br/>
                            Курсы испанского в онлайн-формате не уступают по своему качеству и вовлеченности
                            ...
                            разговаривать на испанском языке с самых первых занятий, даже на начальном уровне. Мы
                            полностью погружаем вас в живой современный испанский и учим применять его на практике.
                            <br/><br/>
